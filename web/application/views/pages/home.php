            ...
            <div class="col-md-4 col-sm-6">
                <div class="card border-0 mb-grid-gutter">
                    ...
                    <div class="card-body border mt-n1 py-4 text-center">
                        <h2 class="h5 mb-1"><?php echo $hotel['nombre']; ?></h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class="font-weight-semibold">$49.99</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="<?php echo site_url('/hotel/'.$hotel['slug']); ?>">Mas información</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
